...
Transaction submission may use any `traffic_viable?` relay; sticky remains preferred, with ordered pool fallback (sticky → traffic-best seeds → chain-qualified relays).
