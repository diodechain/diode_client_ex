defmodule DiodeClient.Contracts.Factory do
  ...
  @constructor_base Base16.decode(
                          ""
                        )
  ...
  def contracts(DiodeClient.Shell.Base) do
    factory = Hash.to_address(0x1a36092d88fB73692eE7c502978D634C4AfCC486)

    %List{
      bns: Hash.to_address(0x87C1D1304944a9EA16aF18CB777E3CeE0D3dACEa),
      bns_postfix: "base",
      ...
      proxy_code_hash:
        Hash.keccak_256(
          @constructor_base <> ABI.encode_args(["address", "address"], [0, factory])
        )
    }
  end
  ...
  def contracts(DiodeClient.Shell.OasisSapphire) do
    ...
    %List{
      ...
      drive_version: 160,
      drive: Hash.to_address(0xC21483AF30F7CFF85483331CB22EB849A4347702),
      factory: factory,
      fleet_member: Hash.to_address(0x0),
      proxy_code_hash:
        Hash.keccak_256(
