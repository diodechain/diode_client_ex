defmodule DiodeClient.Contracts.Factory do
  ...
  def contracts(DiodeClient.Shell.OasisSapphire) do
    ...
    %List{
      ...
      drive_member_version: 120,
      drive_member: Hash.to_address(0xFBBB0CA44D2AA180241F7F70C854ACEAD0FC2796),
      drive_version: 144,
      drive: Hash.to_address(0xADAD2A537205F160B3E0AC0864C24CBF3FFCAFAC),
      factory: factory,
