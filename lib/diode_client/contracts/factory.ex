defmodule DiodeClient.Contracts.Factory do
  ...
  defp contracts(TestShell) do
    contracts(DiodeClient.Shell)
  end

  defp contracts(DiodeClient.Shell) do
  ...
  defp contracts(DiodeClient.Shell.Moonbeam) do
  ...
  defp contracts(DiodeClient.Shell.OasisSapphire) do
